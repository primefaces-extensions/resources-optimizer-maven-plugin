...
/**
 * Forked from YUI Compressor after that project stopped being supported by Yahoo! Inc.
 * <p>
...
public class CssCompressor {
    ...
    public void compress(Writer out, int linebreakpos)
        ...
        css = preserveToken(css, "progid:DXImageTransform.Microsoft.Matrix", "(?i)progid:DXImageTransform.Microsoft.Matrix\\s*([\"']?)", false,
                    preservedTokens);
        ...
        p = Pattern.compile(
                    "(\\=\\s*?[\"']?)?" + "#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])" + "(:?\\}|[^0-9a-fA-F{][^{]*?\\})");
